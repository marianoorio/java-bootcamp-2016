...
public class ServiceShoppingCartTest {
	...
	public void whenAddsItemsToCartTheyAreAdded() {
		Item item0 = new Item("Item0","test item", 00, 12 );
		shopCart.addToCart(item0,4);
		Item item1 = new Item("Item1","test item 1", 12.3, 40);
		shopCart.addToCart(item1,12);
		Item item2 = new Item("Item2","test item 2", 123.1, 14 );
	...
	public void whenGetAllItemsItReturnAListWithThem() {
		...
		shopCart.addToCart(item2,11);
		compare.add(0,item2);
		Item item3 = new Item("Item3","test item 3", 320, 13 );
		shopCart.addToCart(item3,5);
		compare.add(0,item3);
		Item item4 = new Item("Item4","test item 4", 10.2, 24);
		shopCart.addToCart(item4,7);
		compare.add(0,item4);
		Item item5 = new Item("Item5","test item 5", 1.99, 11 );
	...
	public void whenGetTheTotalPriceItIsCalculated() {
		List<Item> compare = new ArrayList<Item>();
		Item item0 = new Item("Item0","test item", 2.5, 12 );
		shopCart.addToCart(item0,2);//TotalPrice?=5
		compare.add(0,item0);
		Item item1 = new Item("Item1","test item 1", 2, 40);
		shopCart.addToCart(item1,1);//TotalPrice?=7
		compare.add(0,item1);
		Item item2 = new Item("Item2","test item 2", 2.5, 14 );
		shopCart.addToCart(item2,4);//TotalPrice?=17
		compare.add(0,item2);
		Item item3 = new Item("Item3","test item 3", 2, 13 );
		shopCart.addToCart(item3,4);//TotalPrice?=25
		compare.add(0,item3);
		Item item4 = new Item("Item4","test item 4", 2.5, 24);
		shopCart.addToCart(item4,3);//TotalPrice?=32.5
		compare.add(0,item4);
		Item item5 = new Item("Item5","test item 5", 2, 11 );
